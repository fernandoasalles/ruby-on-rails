...
class ReceitasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receita" do
    assert_difference("Receita.count") do
      post receitas_url, params: { receita: { ingredientes: @receita.ingredientes, modo_de_preparo: @receita.modo_de_preparo, nome: @receita.nome } }
    end
  ...
  test "should update receita" do
    patch receita_url(@receita), params: { receita: { ingredientes: @receita.ingredientes, modo_de_preparo: @receita.modo_de_preparo, nome: @receita.nome } }
