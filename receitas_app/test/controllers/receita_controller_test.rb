...
class ReceitaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receitum" do
    assert_difference("Receitum.count") do
      post receita_url, params: { receitum: { ingredientes: @receitum.ingredientes, modo_de_preparo: @receitum.modo_de_preparo, nome: @receitum.nome } }
    end
  ...
  test "should update receitum" do
    patch receitum_url(@receitum), params: { receitum: { ingredientes: @receitum.ingredientes, modo_de_preparo: @receitum.modo_de_preparo, nome: @receitum.nome } }
